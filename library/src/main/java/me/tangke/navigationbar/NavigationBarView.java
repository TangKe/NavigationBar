...
class NavigationBarView extends FrameLayout implements OnGlobalLayoutListener {
	...
	public NavigationBarView(Context context, AttributeSet attrs, int defStyleAttr) {
		...
		mTitleNavigationBarItem.text.setTextAppearance(context,
				a.getResourceId(R.styleable.NavigationBar_navigationBarTitleTextStyle, R.style.TextAppearance_NavigationBar_Title));
		mDisplayOptions = a.getInteger(R.styleable.NavigationBar_navigationBarDisplayOptions, NavigationBar.DISPLAY_SHOW_TITLE);
		applyDisplayOptions();
		a.recycle();
